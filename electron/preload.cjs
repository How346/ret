...
contextBridge.exposeInMainWorld("electronAPI", {
  ...
  // clipboard, ready to paste — used by print:html above.
  ...
  // html/widthPx are optional — if whatsapp-web.js can't send the image
  // directly, the main process uses them to open a PDF fallback instead of
  // leaving the cashier with nothing.
  sendBillImage: (base64Image, phone, message, html, widthPx) =>
    ipcRenderer.invoke("send-bill-image", { base64Image, phone, message, html, widthPx }),
